    ...
    for (var key in object) {
      if (object.hasOwnProperty(key)) {
        ...
        if ('object' === typeof object[key]) {
          encodedString += encodeURIComponent(key) + '=' + encodeURIComponent(JSON.stringify(object[key]));
        }
        else {
          encodedString += encodeURIComponent(key) + '=' + encodeURIComponent(object[key]);
        }
      }
    }
    ...
    return new Promise(function(resolve, reject) {
      ...
      if ('POST' === methodType.toUpperCase()) {
        ...
        xhr.upload.addEventListener('progress', function(e) {
          ...
          wuwei.menu.progressbar.move(complete);
        });
      }
