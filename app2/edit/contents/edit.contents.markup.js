  ...
  function axisPanelHtml() {
    return [
      '<section id="edit-contents-axis" class="edit-panel edit-contents-panel" style="display:none;">',
        ...
        '</div>',
        '<div class="edit-field">',
          '<label for="editContentsFirstPageNumber" class="w3-col s6">' + t('Physical page 1 corresponds to') + '</label>',
          '<input id="editContentsFirstPageNumber" class="w3-col s3 edit-value" type="number" step="1" min="1">',
        '</div>',
        '<div class="edit-fiel">',
    ...
    return [
      '<section id="edit-contents-page-marker" class="edit-panel edit-contents-panel" style="display:none;">',
        ...
        '<form id="editform" class="contents-page-marker form-group content" onsubmit="return false;">',
          ...
          '</div>',
          '<div id="pageSequenceNumberRow" class="w3-row">',
            '<label for="pageSequenceNumber" class="w3-col s4">' + t('Page sequence number') + ':</label>',
            '<input type="number" id="pageSequenceNumber" name="pageSequenceNumber" class="w3-col s8 edit-value" min="1" step="1">',
          '</div>',
