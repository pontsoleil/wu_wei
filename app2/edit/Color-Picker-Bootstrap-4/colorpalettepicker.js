(function ($) {
    ...
    var colorPencil36 = [
        'White', 'Gainsboro', 'DarkGray', 'Gray', 'DimGray', 'Black',
        'RosyBrown', 'Salmon', 'LightPink', 'PaleVioletRed', 'HotPink', 'Crimson',
        'Coral', 'Orange', 'Gold', 'Khaki', 'LemonChiffon', 'Ivory',
        'YellowGreen', 'Chartreuse', 'LimeGreen', 'DarkSeaGreen', 'MediumSpringGreen', 'Honeydew',
        'Turquoise', 'LightCyan', 'PowderBlue', 'LightSkyBlue', 'CornflowerBlue', 'CadetBlue',
        'Thistle', 'Orchid', 'MediumPurple', 'BlueViolet', 'Sienna', 'Brown'
    ];
