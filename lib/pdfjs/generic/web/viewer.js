    ...
    pdfPage.getAnnotations().then(function(annotationsData) {
      ...
      if (self.annotationLayer) {
        ...
        for (i = 0, ii = annotationsData.length; i < ii; i++) {
          ...
          console.log(data, element); /* WuWei */
...
var DocumentAnnotationsView = function documentAnnotationsView(options) {
  var annotations = options.annotations;
  var annotationsView = options.annotationsView;
  while (annotationsView.firstChild) {
    annotationsView.removeChild(annotationsView.firstChild);
  }
